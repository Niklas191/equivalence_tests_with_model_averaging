...
for(i in 1:simu){
  resp1 <- DoseFinding::emax(dose = dose1, e0 =e0, eMax = 5, ed50 = 1) + rnorm(n = n1, mean = 0, sd = sigma1)
  resp2 <- DoseFinding::emax(dose = dose2, e0 = 0, eMax = 5, ed50 = 1) + rnorm(n = n2, mean = 0, sd = sigma2)
