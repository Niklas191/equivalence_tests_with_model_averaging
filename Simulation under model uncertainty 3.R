...
# === File description ========================================================================================================================================
# This file contains the code for the simulation of the secound scenario. 
...
for(i in 1:simu){
  resp1 <- DoseFinding::exponential(dose = dose1, e0 =e0, e1 = 2.2, delta = 8) + rnorm(n = n1, mean = 0, sd = sigma1)
  resp2 <- DoseFinding::exponential(dose = dose2, e0 = 0, e1 = 2.2, delta = 8) + rnorm(n = n2, mean = 0, sd = sigma2)
